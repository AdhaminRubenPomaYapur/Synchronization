...
namespace SystemTransaction.Dal.DBContext
{
    ...
    public partial class MyTicketDbContextCloud : DbContext
    {
        public MyTicketDbContextCloud()
        {
        }

        public MyTicketDbContextCloud(DbContextOptions<MyTicketDbContextCloud> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseNpgsql("Server=34.132.91.67;Port=5432;User Id=be-ticket;Password=Passw0rd*;Database=MyTicketDb;");
